    ...
    <section id="home" className="relative min-h-screen pt-28 pb-16 flex items-center justify-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          ...
          {/* LEFT COLUMN: 3D REAL-TIME PHYSICAL LANYARD CARD */}
          <motion.div
          ...
          {/* RIGHT COLUMN: HERO TEXT & CTA (SWAPPED TO RIGHT SIDE) */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-zinc-900 border border-zinc-800 text-xs font-medium text-zinc-300 w-fit mb-6">
              ...
              <span>Pendidikan Teknologi Informasi • Universitas Brawijaya</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-zinc-400 max-w-2xl leading-relaxed mb-8">
              Mahasiswa <strong className="text-zinc-200">Pendidikan Teknologi Informasi (UB)</strong> yang berfokus pada pengembangan aplikasi web modern, arsitektur perangkat lunak yang bersih, dan antarmuka interaktif yang responsif.
            </p>

            {/* Tech Stack Badges */}
            <div className="flex flex-wrap gap-2 mb-8">
              {['React.js', 'Tailwind CSS', 'Framer Motion', 'TypeScript', 'Node.js'].map((tech) => (
                <span
                  key={tech}
            ...
            {/* SUBTLE MINIMALIST DECORATIVE STATS */}
            <div className="pt-6 border-t border-zinc-800/80 grid grid-cols-3 gap-4 max-w-lg">
              <div>
                <div className="text-xl sm:text-2xl font-bold text-white font-mono">10+</div>
                <div className="text-xs text-zinc-400">Project Selesai</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl font-bold text-white font-mono">UB</div>
