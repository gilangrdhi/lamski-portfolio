...
export function ReactLogoIcon({ size = 22, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function VSCodeLogoIcon({ size = 22, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M23.15 2.587L18.21.21a1.494 1.494 0 0 0-1.705.29l-9.46 8.63-4.12-3.128a.999.999 0 0 0-1.276.057L.327 7.276a1 1 0 0 0 .004 1.442l4.084 3.791-4.084 3.791a1 1 0 0 0-.004 1.442l1.322 1.217a.999.999 0 0 0 1.276.057l4.12-3.128 9.46 8.63a1.492 1.492 0 0 0 1.705.29l4.94-2.377A1.5 1.5 0 0 0 24 21.06V2.94a1.5 1.5 0 0 0-.85-1.353zm-6.15 14.862L9.845 12l7.155-5.449v10.898z" />
    </svg>
  );
}

export function TailwindLogoIcon({ size = 22, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
